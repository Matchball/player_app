...
/*
        *//*int day = joiningdate.getDayOfMonth();
        ...
        Toast.makeText(Signup.this, "getextras : "+city +center +joiningdate2+vacancydec, Toast.LENGTH_LONG).show();
                ...
                if (dataSnapshot.getChildrenCount() < 1) {
                    ...
                    playerpdata.child(userId).addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            Toast.makeText(Signup.this, "Player Data entered successfully", Toast.LENGTH_LONG).show();
                            updateCounter();
                        ...
                        public void onCancelled(DatabaseError databaseError) {
                            Toast.makeText(Signup.this, "Data could not be entered check connection", Toast.LENGTH_LONG).show();
                        }
                    });
                } else {
                    Toast.makeText(Signup.this, "Id already taken try another", Toast.LENGTH_LONG).show();
                }
            }
